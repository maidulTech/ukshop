...
<head>
    ...
    <title>Your Order Has been Default</title>
</head>
<body>
    <!DOCTYPE html>
    <html lang="en">
                        ...
                        <tr>
                            <td align="center" valign="top" style="height:100%;margin:0;padding:0;width:100%">
                                <table cellpadding="0" cellspacing="0" border="0" height="210" width="100%" style="border-collapse:collapse">
                                    <tbody>
                                        <tr>
                                            <td bgcolor="#ffa73b" valign="bottom">
                                                <div>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td valign="top" style="padding-right:9px;padding-left:9px;padding-top:0;padding-bottom:0;text-align:center">
                                                                                                    <a href="http://ww2.azuramart.com"title="" target="_blank">
                                                                                                        <img align="center" alt=""src="{{ env('APP_URL') }}public/app-assets/images/logo/white-logo-plain.png" width="248" style="max-width:496px;padding-bottom:0;display:inline!important;vertical-align:bottom;border:0;height:auto;outline:none;text-decoration:none">
                                                                                                    </a>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td valign="top" style="padding-top:0;padding-right:30px;padding-bottom:30px;padding-left:30px;word-break:break-word;color:#5f7d95;font-family:Helvetica;font-size:16px;text-align:left">
                                                                                                <p style="font-size:26px;color:#374957;margin:0;font-weight:600;padding:0;font-family:Helvetica,Arial;line-height:150%;text-align:left">Default Notice!!!</p>
                                                                                                ...
                                                                                                <h4 style="color: #F78902;font-size: 15px;">ORDER ID: <span style="color:#374957; font-weight: 100;">ORD-{{ $rows->BOOKING_NO }}</span></h4>
                                                                                                <?php
                                                                                                $date=date_create($rows->RECONFIRM_TIME);
                                                                                                ?>
                                                                                                <h4 style="color: #F78902;font-size: 15px;">ORDER DATE: <span style="color:#374957; font-weight: 100;">{{ $date->format('d F, Y') }}</span></h4>

                                                                                                <p style="line-height: 140%;">You may remember we sent you an arrival notice for your order, you’ve placed with us and we notice you haven’t settled your balance within the agreed time. If you don’t settle your balance or hear from you within 7 days from this email date, we are going to cancel your order and no refund will made if you have paid any deposit.</p>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td valign="top"
                                                                                                ...
                                                                                                <a href="http://ww2.azuramart.com" title="" target="_blank">
                                                                                                    <img align="center" alt="" src="{{ env('APP_URL') }}public/app-assets/images/logo/Azura_sma_logo.png" width="301" style="max-width:602px;padding-bottom:0;display:inline!important;vertical-align:bottom;border:0;height:auto;outline:none;text-decoration:none">
                                                                                                </a>
