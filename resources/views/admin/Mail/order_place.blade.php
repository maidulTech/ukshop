...
<head>
    ...
    <title>Your Order Has been Placed in AZURAMART</title>
</head>
<body>
    <!DOCTYPE html>
    <html lang="en">
                                                                                                            ...
                                                                                                            <tr style="width:100%">
                                                                                                                <td style="width:50%;text-align:left">
                                                                                                                    <p style="margin-top:1px;margin-bottom:1px">
                                                                                                                        ...
                                                                                                                        Reseller
                                                                                                                        @endif
                                                                                                                         No : {{ $rows['order_info']->getCustomer->CUSTOMER_NO ?? $rows['order_info']->getReseller->CUSTOMER_NO }}</p>
                                                                                                                </td>
                                                                                                ...
                                                                                                <div style="padding: 10px;font-family: Helvetica,Arial;">
                                                                                                    <table style="margin:0;padding:0;width:100%" cellspacing="0" cellpadding="0" border="0">
                                                                                                        <thead style="width:100%">
                                                                                                            <tr style="width:100%;background-color:#F78902;color:#fff">
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            ...
                                                                                                            <?php
                                                                                                            $postage += $item->qty*$item->postage;
                                                                                                            $freight += $item->qty*$item->freight;
                                                                                                            ?>
                                                                                                            <tr>
                                                                                                                <td style="margin-bottom: 4px;display: block;"></td>
                                                                                                            </tr>
                                                                                                            <tr style="border-bottom:2px solid #F78902">
                                                                                                                <td style="text-align:center">{{ $loop->index+1 }}</td>
                                                                                                                <td style="text-align:center;padding-right: 5px;">
                                                                                                                    <img src="{{ env('APP_URL') }}public/{{ $item->PRD_VARIANT_IMAGE_PATH }}" alt="{{ $item->PRD_VARINAT_NAME }}" style="width:100px;height:120px">
                                                                                                                </td>
                                                                                                                <td>
                                                                                                            ...
                                                                                                            @endforeach
                                                                                                            <tr>
                                                                                                                <td style="border-bottom: 3px solid #F78902;"></td>
                                                                                                                <td style="border-bottom: 3px solid #F78902;"></td>
                                                                                                                <td style="border-bottom: 3px solid #F78902;"></td>
                                                                                                                <td style="border-bottom: 3px solid #F78902;"></td>
                                                                                                            </tr>
                                                                                                            ...
                                                                                                            <?php $total += $freight ?>
                                                                                                            <tr>
                                                                                                                <td colspan="3" style="text-align:right">Freight charge </td>
                                                                                                                <td style="text-align:right">{{ number_format($freight,2) }}</td>
                                                                                                            </tr>
                                                                                                            @endif
                                                                                                            <tr>
                                                                                                                <td colspan="3" style="text-align:right"><strong>Total</strong> </td>
                                                                                                                <td style="text-align:right"><strong>{{ number_format($total,2) }}</strong>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </tbody>
                                                                                                    </table>
