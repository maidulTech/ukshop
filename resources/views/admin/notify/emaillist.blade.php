                        ...
                        <div class="card-header">
                            <div class="form-group">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="{{ route('admin.notify_email.list') }}" class="btn btn-success btn-sm  {{ request()->get('type') != 'success' ? 'active' : '' }}"><i class="la la-th-list"></i> Pending</a>
                                    <a href="{{ route('admin.notify_email.list',['type' => 'success']) }}" class="btn btn-success btn-sm {{ request()->get('type') == 'success' ? 'active' : '' }}"><i class="la la-list-ol"></i> Success</a>
                                </div>
                            </div>
