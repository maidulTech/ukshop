    ...
    <th id="checkbox_th" style="width: 1%;">
        ...
        <div id="checkbox_delete{{ $data->PK_NO }}" style="width: 100%">
            <div style="" id="checkbox_div" class="">
                ...
                <a href="javascript:void(0)" class="btn btn-xs {{ $data->PRODUCT_STATUS == 420 || $data->IS_FAULTY == 1 ? 'btn-danger' : 'btn-warning' }} mb-05 mr-05" title="Mark Faulty" data-pk_no="{{ $data->PK_NO }}" data-product_status="{{ $data->PRODUCT_STATUS }}" data-is_faulty="{{ $data->IS_FAULTY }}" data-booking_no="{{ $data->F_BOOKING_NO ?? 0 }}" id="mark_faulty_popup{{ $data->PK_NO }}"><i class="la la-warning"></i></a>
            </div>
        </div>
        @endforeach
    </th>
