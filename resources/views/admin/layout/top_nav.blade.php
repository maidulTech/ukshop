<div class="navbar-header">
    <ul class="nav navbar-nav flex-row">
        ...
        <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ route('admin.dashboard') }}">
            <img class="brand-logo img-fluid" alt="modern admin logo" src="{{asset('/app-assets/images/logo/Azura_sma_logo.png')}}">
                {{-- <h3 class="brand-text">UKSHOP</h3> --}}
            </a></li>
    ...
    <div class="collapse navbar-collapse" id="navbar-mobile">
        ...
        <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-user nav-item" style="position: absolute;right:0px;">
                <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1 user-name text-bold-700"> {{ Auth::user()->USERNAME }}</span><span class="avatar avatar-online"><img src="{{asset('/media/images/profile')}}/{{ Auth::user()->PROFILE_PIC }}" alt="avatar"><i></i></span>
                </a>
