          ...
          <div class="card-content  collapse show">
            <div class="card-body card-dashboard text-center">
              <div class="table-responsive">
                ...
                <table class="table-striped table-bordered table-sm" id="example">
...
<script type="text/javascript" src="{{ asset('app-assets/pages/brand.js?v=1.28')}}"></script>
{{-- Data Table Plugin --}}
{{-- <script src="//cdn.datatables.net/plug-ins/1.10.24/pagination/simple_incremental_bootstrap.js"></script> --}}
