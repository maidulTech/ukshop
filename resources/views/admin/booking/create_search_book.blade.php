            ...
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group {!! $errors->has('ig_code') ? 'error' : '' !!}">
                                    <label class="mb-1">Product Keyword<span class="text-danger">*</span></label>
                    ...
                    <div class="form-actions mt-10 text-center">
                        ...
                        <button type="button" class="btn btn-primary save-inv-details submit_button_book2"  value="book"><i class="la la-check-square-o"></i> Proceed to Booking </button>
