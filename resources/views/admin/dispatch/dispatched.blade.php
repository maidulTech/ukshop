        ...
        <div class="card-body" style="padding: 15px 5px;">
            <div class="row">
                <div class="col-md-12 text-center">
                    <form class="form-inline" action="{{ route('admin.dispatched.list') }}" style="position: relative;" method="get" id="dispatchedFrm">
                        <div class="form-group">
                            <input type="text" class="form-control form-control-sm pickadate" id="from_date" placeholder="From Date" name="from_date" value="{{ request()->get('from_date') }}">
                        </div>
                        <div class="form-group">
                            &nbsp;&nbsp;
                        <input type="text" class="form-control form-control-sm pickadate" id="to_date" placeholder="To date" name="to_date" value="{{ request()->get('to_date') }}">
                        </div> &nbsp; &nbsp;
                        <button type="submit" class="btn btn-info btn-sm">Search</button> &nbsp; &nbsp; &nbsp;
                        <a href="{{ route('admin.dispatched.list') }}" class="btn btn-info btn-sm">Reset</a>
                        <div class="form-group " style="position: absolute; right:0;">
                        <input type="text" class="form-control" name="keywords" placeholder="search by customer name, order id or tracking no" style="min-width: 300px;" title="search by customer name, order id or tracking no" value="{{ request()->get('keywords') }}">
                        </div>
                    </form>
